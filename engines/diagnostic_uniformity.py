...
# Run once or weekly to test whether front and back digits
...
# Note: this file uses single-quoted strings only and no triple

# quotes anywhere, to avoid auto-conversion of double quotes

# into smart quotes by mobile keyboards or web editors.
...
# Chi-square goodness-of-fit vs uniform over 10 categories.
# Returns (chi2_stat, df, approx_p_value).
# Wilson-Hilferty transformation gives p-value from chi2 with df=9.
